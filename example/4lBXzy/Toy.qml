...
ShaderToy {
    ...
    // 默认有 VFlip 所以看起来模糊，这里得继续跟进

    base: "https://www.shadertoy.com/view/4lBXzy"
    title: "Fiery Spikeball"
    describe: "Making some modifications to Duke's \"Cloudy Spikeball\" port to produce a fiery version."
