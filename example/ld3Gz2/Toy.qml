...
ShaderToy {
    ...
    base: "https://www.shadertoy.com/view/ld3Gz2"
    title: "Snail"
    describe: "Procedural modeling and procedural lighting. Shading is a mix of procedural and textures. Raymarched. You'll need a fast machine for this one."

    NumberAnimation on iGlobalTime { loops: Animation.Infinite; from: 0; to: Math.PI * 4; duration: 2048 }
